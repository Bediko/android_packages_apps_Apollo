 ...
 * Original file: /home/bediko/code/java/android_packages_apps_Apollo/src/com/andrew/apollo/IApolloService.aidl
 */
...
static final int TRANSACTION_setQueuePosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getPath = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
...
static final int TRANSACTION_getShuffleMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_removeTracks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_removeTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setRepeatMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getRepeatMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getMediaMountedCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getAudioSessionId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_addToFavorites = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_removeFromFavorites = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_isFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_toggleFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
public void openFile(java.lang.String path) throws android.os.RemoteException;
public void open(long[] list, int position) throws android.os.RemoteException;
public int getQueuePosition() throws android.os.RemoteException;
